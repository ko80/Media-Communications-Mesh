...
void ProxyContext::ParseSt20RxOps(const mcm_conn_param* request, struct st20p_rx_ops* ops_rx)
{
    ...
    // ops_rx->port.udp_port[MTL_PORT_P] = RX_ST20_UDP_PORT; request->payload_type_nr request->payload_mtl_flags_mask
    ...
    // ops_rx->transport_fmt = ST20_FMT_YUV_422_10BIT; ST20_FMT_YUV_422_PLANAR10LE
    // ops_rx->output_fmt = ST_FRAME_FMT_YUV422RFC4175PG2BE10; ST_FRAME_FMT_YUV422PLANAR10LE
    // ops_rx->transport_fmt = ST20_FMT_YUV_422_8BIT;rx_st20p_get_converter
...
void ProxyContext::ParseSt20TxOps(const mcm_conn_param* request, struct st20p_tx_ops* ops_tx)
{
    ...
    // ops_tx->input_fmt = ST_FRAME_FMT_YUV422RFC4175PG2BE10;ST_FRAME_FMT_YUV422PLANAR10LE
