...
const char * result2str(Result res)
{
    ...
    case Result::error_not_supported:    return "error: not supported";
    case Result::error_wrong_state:      return "error: wrong state";
    case Result::error_no_link_assigned: return "error: no link assigned";
    default:                             return str_unknown;
    }
}
